...
struct LandscapeOptions
{
	...
	// for spherical textures only, the elevation from the horizon
	angle Elevation;
	...
	LandscapeOptions(): HorizExp(1), VertExp(1), OGL_AspRatExp(0), VertRepeat(false), Azimuth(0), Elevation(0), SphereMap{false} {}
};
