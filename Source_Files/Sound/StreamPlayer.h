...
public:
	...
	float GetPriority() const override { return 10; } //As long as it's only used for net mic, it doesn't really matter, just be above maximum volume (1) to be prioritized
private:
