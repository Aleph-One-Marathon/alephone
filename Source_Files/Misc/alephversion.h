...
#define A1_DISPLAY_VERSION "1.6.2"
#define A1_DISPLAY_DATE_VERSION "2023-05-29"
#define A1_DATE_VERSION "20230529"

#ifdef WIN32
#define WIN_VERSION_STRING 0,2023,05,29 // <-- don't forget to update that for windows releases
