...
#define A1_DISPLAY_VERSION "1.11b"
#define A1_DISPLAY_DATE_VERSION "2025-08-08"
#define A1_DATE_VERSION "20250808"

#ifdef _WIN32
#define WIN_VERSION_STRING 0,2025,8,8 // <-- don't forget to update that for windows releases
