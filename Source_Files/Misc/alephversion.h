...
#define A1_DISPLAY_VERSION "1.5rc1"
#define A1_DISPLAY_DATE_VERSION "2021-10-30"
#define A1_DATE_VERSION "20211030"

#ifdef WIN32
#define WIN_VERSION_STRING 0,2021,10,30 // <-- don't forget to update that for windows releases
