...
#define A1_DISPLAY_VERSION "1.10.1"
#define A1_DISPLAY_DATE_VERSION "2025-03-02"
#define A1_DATE_VERSION "20250302"

#ifdef _WIN32
#define WIN_VERSION_STRING 0,2025,3,2 // <-- don't forget to update that for windows releases
